<?php
  ...
  /****
  Token: X26WjNJo80-dsNZdqP_EOaB5sWFnlWCcL1cGez1vBc2EkNYiofLjzAmbzUSFNZe0
  User: restuser
  IP: 128.208.180.170
  Created: 6/1/2011
  Expires: 3000 days
  ****/
  $serverUrls = array(
		array( 'url' => 'https://geosims.cpo.uw.edu/arcgis/rest/services/', 'matchAll' => true, 'token' => '' )
  );
  /***************************************************************************/
  ...
  if (isset($_SERVER['CONTENT_TYPE'])) {
  	$headerArr['Content-Type'] = $_SERVER['CONTENT_TYPE'];
  }
  if (isset($_SERVER['HTTP_REFERER'])) {
  	$headerArr['Referer'] = $_SERVER['HTTP_REFERER'];
  }
  ...
  //$getimagesize = getimagesize($response);
  //$response = rtrim($response, "}");
  //$response = $response . ",\"targUrl\":\"" . $targetUrl . "\"}";
